 ...
 * #SAFEORBITTOKEN
   ...
   - 3% of every transaction is converted to BNB and sent to the marketing wallet
   ...
   100,000 tokens limitation for sell, which is 1% of the total supply.
...
contract VERO is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0xA7482C9c5926E88d85804A969c383730Ce100639;
    ...
    string private _name = "VEROTOKEN";
    string private _symbol = "VERO";
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        TransferBnbToExternalAddress(_devWalletAddress, newBalance.div(_marketingFee + _devFee + _liquidityFee).mul(_devFee));
